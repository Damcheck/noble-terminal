...
const TICKER_SYMBOL_MAP: Record<string, { storeKey: string; finnhubKey: string }> = {
  ...
  'XAU/USD':  { storeKey: 'GC=F',      finnhubKey: 'XAUUSD' },
  'BTC/USD':  { storeKey: 'BTC-USD',   finnhubKey: 'BTC-USD' },
  'EUR/USD':  { storeKey: 'EURUSD=X',  finnhubKey: 'EURUSD' },
  'GBP/USD':  { storeKey: 'GBPUSD=X',  finnhubKey: 'GBPUSD' },
  'VIX':      { storeKey: '^VIX',      finnhubKey: '^VIX' },
  'USD/NGN':  { storeKey: 'USDNGN=X',  finnhubKey: 'USDNGN' },
  'WTI OIL':  { storeKey: 'CL=F',      finnhubKey: 'USOIL' },
