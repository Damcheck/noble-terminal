        ...
        headers: [
          ...
          // - Images from anywhere (logos, news thumbnails)
          {
            ...
            value: [
              ...
              "connect-src 'self' wss://ws.finnhub.io https://finnhub.io https://*.supabase.co wss://*.supabase.co https://api.alternative.me https://forexlive.com https://cointelegraph.com https://investing.com",
              "frame-src 'self' https://s3.tradingview.com https://www.tradingview.com https://investing.com",
              "media-src 'self' https://www.youtube.com https://stream.cnbc.com blob:",
